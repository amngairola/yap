...
const GoogleIcon = () => (
  <svg className="h-5 w-5" viewBox="0 0 48 48">
    ...
    <path
      fill="#4CAF50"
      d="M24,44c5.166,0,9.86-1.977,13.409-5.192l-6.19-5.238C29.211,35.091,26.715,36,24,36c-5.222,0-9.617-3.234-11.303-7.592l-6.571,4.819C9.656,39.663,16.318,44,24,44z"
    ></path>
    <path
      fill="#1976D2"
      d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.574l6.19,5.238C39.904,36.463,44,30.836,44,24C44,22.659,43.862,21.35,43.611,20.083z"
    ></path>
  </svg>
);
  ...
  return (
    ...
    <div className="flex h-screen w-full items-center justify-center p-4">
      ...
      <div className="w-full max-w-md rounded-2xl border border-white/10 bg-black/30 p-8 shadow-2xl backdrop-blur-lg">
        ...
        {/* --- Social Login Button --- */}
        <button className="flex w-full items-center justify-center space-x-3 rounded-lg bg-white/10 py-3 text-sm font-semibold text-white transition-colors hover:bg-white/20">
          <GoogleIcon />
